...
<html lang="id" class="light">
    <head>
        <meta charset="UTF-8">
        <title>Kalender Tugas | To-Do List</title>
        ...
        <nav class="sticky top-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
            <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-extrabold tracking-tight">Calendar View</span>
                </div>
                <div class="flex items-center gap-4">
                    <a href="TodoServlet" class="text-sm font-bold text-slate-500 hover:text-primary flex items-center gap-1">
                        <span class="material-icons-round text-[18px]">arrow_back</span> Kembali ke List
                    </a>
                </div>
            </div>
        </nav>
